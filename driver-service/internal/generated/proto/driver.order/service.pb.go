...
type StartOrderRequest struct {
	...
	PointA    *Location              `protobuf:"bytes,3,opt,name=pointA,proto3" json:"pointA,omitempty"`
	PointB    *Location              `protobuf:"bytes,4,opt,name=pointB,proto3" json:"pointB,omitempty"`
...
func (x *StartOrderRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *StartOrderRequest) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *StartOrderRequest) GetPointA() *Location {
	if x != nil {
		return x.PointA
	}
	return nil
...
func (x *StartOrderRequest) GetPointB() *Location {
	if x != nil {
		return x.PointB
	}
	return nil
...
func (x *StartOrderRequest) GetUserID() int64 {
	if x != nil {
		return x.UserID
	}
	return 0
...
type StartOrderResponse struct {
	...
	DriverId *int64 `protobuf:"varint,1,opt,name=driverId,proto3,oneof" json:"driverId,omitempty"`
}
...
func (x *StartOrderResponse) GetDriverId() int64 {
...
var file_api_proto_service_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbb, 0x01, 0x0a, 0x11, 0x53,
	0x74, 0x61, 0x72, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x12, 0x21, 0x0a, 0x06, 0x70, 0x6f,
	0x69, 0x6e, 0x74, 0x41, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x4c, 0x6f, 0x63,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x06, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x41, 0x12, 0x21, 0x0a,
	0x06, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x42, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x09, 0x2e,
	0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x06, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x42,
	0x12, 0x16, 0x0a, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x44, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x44, 0x22, 0x44, 0x0a, 0x08, 0x4c, 0x6f, 0x63, 0x61,
	...
	,
...
var file_api_proto_service_proto_goTypes = []interface{}{
	(*StartOrderRequest)(nil),     // 0: StartOrderRequest
	(*Location)(nil),              // 1: Location
	(*StartOrderResponse)(nil),    // 2: StartOrderResponse
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_api_proto_service_proto_depIdxs = []int32{
	3, // 0: StartOrderRequest.createdAt:type_name -> google.protobuf.Timestamp
	1, // 1: StartOrderRequest.pointA:type_name -> Location
	1, // 2: StartOrderRequest.pointB:type_name -> Location
	0, // 3: Order.StartOrder:input_type -> StartOrderRequest
	2, // 4: Order.StartOrder:output_type -> StartOrderResponse
...
func file_api_proto_service_proto_init() {
	...
	file_api_proto_service_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
